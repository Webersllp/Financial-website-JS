...
$(function() {
  ...
  if(bgndKenburnsFull.length){
    bgndKenburnsFull.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "https://images.unsplash.com/photo-1449157291145-7efd050a4d0e?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=870&q=80" },
  ...
  // KBW-Countdown Start
  // --------------------------------------------- //
  $('#countdown').countdown({until: $.countdown.UTCDate(+10, 2021, 9, 16), format: 'D'});
  $('#countdown-large').countdown({until: $.countdown.UTCDate(+10, 2021, 9, 16), format: 'DHMS'});
  // --------------------------------------------- //
  // KBW-Countdown End
  // --------------------------------------------- //
